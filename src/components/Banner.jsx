  ...
  <svg width={"100%"} height={"auto"} viewBox="0 0 1920 450">
    ...
    <g transform="translate(0 -236)">
      ...
      <rect
        ...
        transform="translate(0 236)"
      />
      <text className="b10" transform="translate(240 407.458)">
        <tspan x={0} y={0}>
          {"Welcome to the"}
        </tspan>
      </text>
      <text className="c10" transform="translate(240 480.118)">
        <tspan x={0} y={0}>
          {"NOMINET MEMBER HUB"}
        </tspan>
      </text>
      <g transform="translate(102 442.475)">
        <g transform="translate(1677)">
          <g transform="translate(40 40) rotate(180)">
            ...
            <g transform="translate(8 8)">
              <rect className="e10" width={24} height={24} />
              <path
                className="f10"
        ...
        <g className="g10">
          <circle className="h10" cx={20} cy={20} r={20} />
          <circle className="j10" cx={20} cy={20} r={19.5} />
        </g>
        <g transform="translate(8 8)">
          <rect className="e10" width={24} height={24} />
          <path
